...
void *manejador_conexion(void *socket_desc) {
    ...
    List<string> Chunks() {
        ...
        char nombreOrg[] = "/home/bamdres16/P2_repositorio/mp3/ejemplo.mp3";
...
*/
    ...
    pugi::xml_document XML(int codigo) {
        ...
        if (codigo == 00) {
            ...
            param.insert_attribute_after("path", param.attribute("nombre")) = "/home/bamdres16/P2_repositorio/mp3/ejemplo.mp3";
